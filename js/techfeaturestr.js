...
<ol>
To facilitate quickly writing note on any verse in the Bible, the app  
    <li>utilize the First-Capital Keyboard method, category method, Most-Recent-History(MRH) methods.</li>
    <li>allows to search any word in different versions of Bibles.</li>
    <li>provides predefined external web links for each verse.</li>
    <li>allows to share with other people's notes online.</li>
</ol>
...
<ol>
    ...
    <li>
    To use advanced technology to serve and glorify Him rather than any idol, culture, race and worldly state.
    </li>
</ol>
